...
$url   = 'https://cdn.rawgit.com/michaelmcdaniel/GuidgenConsole/master/Binaries/guidgen-console.2.0.0.3.zip'
$checksum = 'EF5E451CEA1C23BB851997D79ABAEEE9'

$binRoot = $(Split-Path -parent $MyInvocation.MyCommand.Definition)

Install-ChocolateyZipPackage $name $url $binRoot -checksum $checksum -checksumType 'md5'
